...
hl.bind("ALT + SHIFT + 1", hl.dsp.window.move({ monitor = MONITOR1 }))
hl.bind("ALT + SHIFT + 2", hl.dsp.window.move({ monitor = MONITOR2 }))
hl.bind("ALT + SHIFT + mouse_up", hl.dsp.window.move({ monitor = "-1" }))
hl.bind("ALT + SHIFT + mouse_down", hl.dsp.window.move({ monitor = "+1" }))
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(launchPrefix .. SCRIPTS_DIR .. "translate.sh"))
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd(launchPrefix .. SCRIPTS_DIR .. "translate.sh auto"))
hl.bind(mainMod .. " + CTRL + T", hl.dsp.exec_cmd(launchPrefix .. SCRIPTS_DIR .. "translate.sh switch"))
hl.bind(mainMod .. " + SHIFT + CTRL + T", hl.dsp.exec_cmd(launchPrefix .. SCRIPTS_DIR .. "translate.sh set"))
...
hl.bind("ALT + SHIFT + H", hl.dsp.exec_cmd(launchPrefix .. "systemctl hibernate"))
